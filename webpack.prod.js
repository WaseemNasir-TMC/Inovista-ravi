  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        {from: 'app/public/icons/add.svg', to: 'logo_32px.png'},
        {from: 'app/public/icons/add.svg', to: 'logo.png'},
        {from: 'app/public/icons/add.svg', to: 'assets.png'},
        {from: 'app/public/icons/add.svg', to: 'navigator.png'},
        {from: 'app/public/icons/add.svg', to: 'spaces.png'},
        {from: 'app/public/icons/add.svg', to: 'docs.png'},
        {from: 'app/public/icons', to: 'icons'},
        {from: 'app/public/icons/add.svg', to: 'simple_navigator.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_buildingPerformance.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_comfortWellness.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_files.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_smartBuilding.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_spaces.png'},
        {from: 'app/public/icons/add.svg', to: 'simple_assets.png'},
      ]
    }),
